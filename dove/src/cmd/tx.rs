...
#[structopt(usage = "dove tx [call] [OPTIONS]\n
    Examples:
    $ dove tx 'script_name<0x01::Dfinance::USD>([10,10], true, ADDRESS_ALIAS, 100, 0x1)'
    $ dove tx 'script_name()' --parameters [10,10] true ADDRESS_ALIAS 100 0x1 --type 0x01::Dfinance::USD
