...
impl MutString {
    pub fn new(source: String) -> MutString {
        MutString {
            source,
    ...
    pub fn make_patch(&mut self, start_offset: usize, end_offset: usize, new_value: Cow<'static, String>) {
    ...
    pub fn freeze(self) -> String {
        ...
        for Patch { source_range, value } in self.patch_set {
...
pub struct Patch {
    ...
    value: Cow<'static, String>,
}

impl PartialOrd for Patch {
    fn partial_cmp(&self, other: &Self) -> Option<Ordering> {
        other.source_range.start.partial_cmp(&self.source_range.start)
    }
}
...
mod test {
    ...
    fn test_mut_string() {
        ...
        ";
        let mut mut_str = MutString::new(source.to_owned());
        mut_str.make_patch(75, 75 + 47, Cow::Owned("0x1CF326C5AAA5AF9F0E2791E66310FE8F044FAADAF12567EAA0976959D1F7731F".to_owned()));
        mut_str.make_patch(129, 163, Cow::Owned("".to_owned()));
